...
{
    public class UpdateBuyOrderCommand : IRequest<int>
    {
        ...
        public class UpdateBuyOrderCommandHandler : IRequestHandler<UpdateBuyOrderCommand, int>
        {
            private readonly IBuyOrderFacade buyOrderFacade;

            public UpdateBuyOrderCommandHandler(IBuyOrderFacade buyOrderFacade)
            {
                this.buyOrderFacade = buyOrderFacade;
            }
            public Task<int> Handle(UpdateBuyOrderCommand command, CancellationToken cancellationToken)
            {
                var buyOrderDTO = new BuyOrderDTO();
                buyOrderDTO.OrderID = command.OrderID;
                ...
                buyOrderFacade.Update(buyOrderDTO);
