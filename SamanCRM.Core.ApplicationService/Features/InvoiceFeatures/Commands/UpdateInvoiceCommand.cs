...
namespace SamanCRM.Core.ApplicationService.Features.InvoiceFeatures.Commands
{
    public class UpdateInvoiceCommand : IRequest<int>
    {
        ...
        public class UpdateInvoiceCommandHandler : IRequestHandler<UpdateInvoiceCommand, int>
        {
            ...
            public UpdateInvoiceCommandHandler(IInvoiceFacade invoiceFacade)
            {
                this.invoiceFacade = invoiceFacade;
            }
#pragma warning disable CS1998 // Async method lacks 'await' operators and will run synchronously
            public async Task<int> Handle(UpdateInvoiceCommand command, CancellationToken cancellationToken)
            {
                var invoiceDTO = new InvoiceDTO();
                invoiceDTO.InvoiceID = command.InvoiceID;
                ...
                invoiceFacade.Update(invoiceDTO);
