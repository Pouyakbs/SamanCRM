...
{
    public class CreateClueCommand : IRequest<int>
    {
        ...
        public class CreateClueCommandHandler : IRequestHandler<CreateClueCommand, int>
        {
            private readonly ICluesFacade clueFacade;

            public CreateClueCommandHandler(ICluesFacade clueFacade)
            {
                this.clueFacade = clueFacade;
            }
#pragma warning disable CS1998 // Async method lacks 'await' operators and will run synchronously
            public async Task<int> Handle(CreateClueCommand command, CancellationToken cancellationToken)
            {
                ...
                clueDTO.CreatedDate = DateTime.Now;
                clueDTO.ClueGuid = Guid.NewGuid();
                clueFacade.Add(clueDTO);
