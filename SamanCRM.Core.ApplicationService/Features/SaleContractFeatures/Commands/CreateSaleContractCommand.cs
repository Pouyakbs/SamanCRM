...
{
    public class CreateSaleContractCommand : IRequest<int>
    {
        ...
        public class CreateSaleContractCommandHandler : IRequestHandler<CreateSaleContractCommand, int>
        {
            private readonly ISaleContractFacade saleContractFacade;

            public CreateSaleContractCommandHandler(ISaleContractFacade saleContractFacade)
            {
                this.saleContractFacade = saleContractFacade;
            }
#pragma warning disable CS1998 // Async method lacks 'await' operators and will run synchronously
            public async Task<int> Handle(CreateSaleContractCommand command, CancellationToken cancellationToken)
            {
                ...
                saleContractDTO.CreatedDate = DateTime.Now;
                saleContractDTO.ContractGuid = Guid.NewGuid();
                saleContractFacade.Add(saleContractDTO);
