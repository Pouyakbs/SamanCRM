...
{
    public class UpdateProgramPartAccessCommand : IRequest<int>
    {
        ...
        public class UpdateProgramPartAccessCommandHandler : IRequestHandler<UpdateProgramPartAccessCommand, int>
        {
            private readonly IProgramPartFacade programPartFacade;

            public UpdateProgramPartAccessCommandHandler(IProgramPartFacade programPartFacade)
            {
                this.programPartFacade = programPartFacade;
            }
#pragma warning disable CS1998 // Async method lacks 'await' operators and will run synchronously
            public async Task<int> Handle(UpdateProgramPartAccessCommand command, CancellationToken cancellationToken)
            {
                ...
                programPartFacade.UpdateAccess(programPartDTO);
