...
namespace SamanCRM.Core.ApplicationService.Features.ActivitiesFeatures.Commands
{
    public class UpdateActivityCommand : IRequest<int>
    {
        ...
        public class UpdateActivityCommandHandler : IRequestHandler<UpdateActivityCommand, int>
        {
            ...
            public UpdateActivityCommandHandler(IActivitiesFacade activitiesFacade)
            {
...
#pragma warning disable CS1998 // Async method lacks 'await' operators and will run synchronously
            public async Task<int> Handle(UpdateActivityCommand command, CancellationToken cancellationToken)
            {
                ...
                activitiesDTO.ActivityID = command.ActivityID;
                ...
                activitiesFacade.Update(activitiesDTO);
