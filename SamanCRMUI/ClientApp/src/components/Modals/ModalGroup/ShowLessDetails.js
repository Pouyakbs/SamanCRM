...
export const ShowLessDetails = ({getmoredifference}) => {
...
<Editing
    ...
    <Column  caption={t("واحد اصلی")} dataField="HireDate"/>
    <Column  caption={t("واحد ثانویه")} dataField="HireDate"/>
    <Column  caption={t("مقدار واحد ثانویه")} dataField="HireDate" width={150}/>
