...
export default function DisableInputModal({disabled,getData}) {
  console.log("disabled" , getData)
  ...
  return (
    <>
	 <Button onClick={handleOpen} disabled={disabled}><HighlightAltIcon/></Button>
        ...
        <Column dataField="machineWhereaboutsInput" caption = "دسته"/>
    </DataGrid>
            </Box>
