...
import { serviceReason } from './serviceReasons';
import { useTranslation } from "react-i18next";

export default function ServiceReason({getData}) {
  ...
  return (
    <>
        ...
        <Column dataField="serviceReason" caption = "دسته"/>
    </DataGrid>
            </Box>
