...
import {member } from '../../../components/Modals/Mahan_MemberModal/member';

export default function MemberModal({getData}) {
    ...
    const style = {
      ...
      const [selectedMember, setSelectedMember] = React.useState("test")
  ...
  return (
    <>
        ...
        <Column dataField="member" caption = "دسته"/>
    </DataGrid>
            </Box>
