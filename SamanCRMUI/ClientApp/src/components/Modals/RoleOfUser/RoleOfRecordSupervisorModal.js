...
import { roleOfRecordSupervisor } from './roleOfRecordSupervisor';
import { useTranslation } from "react-i18next";




export default function RoleOfRecordSupervisorModal({ getData }) {
    ...
    return (
        <>
            ...
            >
                <Box sx={style}>
                    <DataGrid
                        dataSource={roleOfRecordSupervisor}
                        showBorders={true}
                    ...
                    >
                        ...
                        <Column dataField="roleOfRecordSupervisor" caption="دسته" />
                    </DataGrid>
                </Box>
