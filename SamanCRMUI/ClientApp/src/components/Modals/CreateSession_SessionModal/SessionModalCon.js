...
import { mortabs } from '../../../components/Modals/CreateSession_SessionModal/mortabs';
import { useTranslation } from "react-i18next";

export default function SessionModalCon({disabled,getData}) {
  ...
  return (
    <>
        ...
        <Column dataField="should" caption = "دسته"/>
    </DataGrid>
            </Box>
