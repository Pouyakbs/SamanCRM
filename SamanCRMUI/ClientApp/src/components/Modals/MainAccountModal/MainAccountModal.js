...
export default function MainAccountModal({getData}) {
  const { t, i18n } = useTranslation();
    ...
    const style = {
      ...
      const [selectedMainAccount, setSelectedMainAccount] = React.useState("test")
  ...
  return (
    <>
        ...
        <Column dataField="mainAccount" caption = "دسته"/>
    </DataGrid>
            </Box>
