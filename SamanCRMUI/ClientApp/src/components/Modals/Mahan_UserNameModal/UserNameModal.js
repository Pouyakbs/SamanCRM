...
import { userName } from '../../../components/Modals/Mahan_UserNameModal/userName';

export default function UserNameModal({getData}) {
    ...
    const style = {
      ...
      const [SelectedUserName, setSelectedUserName] = React.useState("test")
  ...
  return (
    <>
        ...
        <Column dataField="userName" caption = "دسته"/>
    </DataGrid>
            </Box>
