...
export default function NothingModal({disabled,getData}) {
  ...
  return (
    <>
        <Button  disabled={disabled}  onClick={handleOpen} ><HighlightAltIcon/></Button>
        ...
        <Column dataField="nothings" caption = "دسته"/>
    </DataGrid>
            </Box>
