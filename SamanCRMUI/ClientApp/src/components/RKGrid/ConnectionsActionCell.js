...
const ActionCell=(props)=>{
    ...
    const removePersonnel = () => {
        let isSuccess = false;
        axios
          .delete(`${appConfig.BaseURL}/api/connections/${props.dataItem.connectionsID}`)
          .then((res) => {
        ...
        const transferToForm = () => {
            history.navigate(`/marketing/connections/newConnections?id=${props.dataItem.connectionsID}`)
        }
    const style = {
        position: 'absolute',
        top: '50%',
