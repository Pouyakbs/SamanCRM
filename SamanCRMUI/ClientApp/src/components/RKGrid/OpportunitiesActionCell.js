...
const ActionCell=(props)=>{
    ...
    const removePersonnel = () => {
        let isSuccess = false;
        axios
          .delete(`${appConfig.BaseURL}/api/Opportunities/${props.dataItem.opportunityID}`)
          .then((res) => {
        ...
        const transferToForm = () => {
            history.navigate(`/sale/Opportunities/NewOpportunities?id=${props.dataItem.opportunityID}`)
        }
    const style = {
        position: 'absolute',
        top: '50%',
