...
const ActionCell=(props)=>{
    ...
    const removeProduct = () => {
        let isSuccess = false;
        axios
          .delete(`${appConfig.BaseURL}/api/BuyOrder/${props.dataItem.orderID}`)
          .then((res) => {
        ...
        const transferToForm = () => {
            history.navigate(`/inventory-management/purchase-orders/create-order?id=${props.dataItem.orderID}`)
        }
    const style = {
        position: 'absolute',
        top: '50%',
