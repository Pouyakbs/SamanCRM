...
const ActionCell=(props)=>{
    ...
    const removePersonnel = () => {
        let isSuccess = false;
        axios
          .delete(`${appConfig.BaseURL}/api/supplier/${props.dataItem.supplierID}`)
          .then((res) => {
        ...
        const transferToForm = () => {
            history.navigate(`/inventory-management/suppliers/create-supplier?id=${props.dataItem.supplierID}`)
        }
    const style = {
        position: 'absolute',
        top: '50%',
