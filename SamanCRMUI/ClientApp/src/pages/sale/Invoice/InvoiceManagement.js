...
import InvoiceActionCell from "../../../components/RKGrid/InvoiceActionCell";
...
const InvoiceManagement = () => {
    ...
    const ActionCellData = (props) => (
        <InvoiceActionCell {...props} getData={getData} />
    );
    let tempColumn = [
        {
            field: "IndexCell",
        ...
        <>
            ...
            >
                <RKGrid
                    ...
                    showPrint={true}
                    showAdd={true}
                    excelFileName={"invoiceIDDetails"}
                    chartDependent={chartObj}
                    rowCount={10}
                    addUrl={"/sale/Invoice/NewInvoice"}
                    addTitle={"افزودن اطلاعات فاکتور"}
