...
export const InvoiceForm = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      status: Yup.string()
        .required("وارد کردن وضعیت الزامی است")
        .nullable(true),
      accountID: Yup.string().required("وارد کردن حساب الزامی است"),
      personsID: Yup.string().required("وارد کردن فرد الزامی است"),
      preInvoiceID: Yup.string().required("وارد کردن پیش فاکتور الزامی است"),
      invoiceDate: Yup.string().required("وارد کردن تاریخ الزامی است"),
      postalCode: Yup.string()
        .length(10, "کد پستی باید 10 رقم باشد")
        .matches(
          /^\b(?!(\d)\1{3})[13-9]{4}[1346-9][013-9]{5}\b/,
          "کد پستی صحیح نمیباشد"
        ),
      ...
      relatedTo: Yup.string()
        .required("وارد کردن مرتبط با الزامی است")
        .nullable(true),
  ...
  const factorSub = () => {
    swal({
      title: t("اطلاعات فاکتور با موفقیت ثبت شد"),
      icon: "success",
      button: t("باشه"),
    });
  };
      ...
      >
        ...
        <form className="Position-relative" onSubmit={formik.handleSubmit}>
                ...
                <div className="form-design">
                  <div className="row">
                    ...
                    <div className="content col-lg-6 col-md-6 col-xs-12">
                      <div className="title">
                        <span>
                          {t("تاریخ فاکتور")} <span className="star">*</span>
                        </span>
                      </div>
                    ...
                    >
                      <div className="title">
                        <span>
                          {t("مرتبط با")} <span className="star">*</span>{" "}
                        </span>
                      </div>
                      <div className="wrapper">
                        <div style={{ position: "relative" }}>
              ...
              >
                <div className="form-design">
                  <div className="row">
                    ...
                    >
                      <div className="title">
                        <span>{t("مشکلات تائید داخلی")}</span>
                      </div>
                      <div className="wrapper">
                        <div>
                          {id != null &&
          ...
          <Accordion defaultExpanded={true}>
            ...
            >
              <Typography>
                <span>{t("اطلاعات اعتبارسنجی")}</span>
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
              <div
